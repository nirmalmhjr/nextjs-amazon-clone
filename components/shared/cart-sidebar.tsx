...
import { FREE_SHIPPIN_MIN_PRICE } from "@/lib/constants";
                ...
                <div className='my-3'>
                  ...
                  <div className='flex gap-2 mt-2'>
                    ...
                    >
                      ...
                      <SelectContent    // force it to render inside the same DOM tree
                          // position="popper"
                          // side="bottom"
                          align="start"
                          // disable portal so it stays inside parent
                          // portal={false}
                          className="h-100"
                          >
