...
import { APP_NAME, FREE_SHIPPIN_MIN_PRICE } from "@/lib/constants"
                                                ...
                                                <div>
                                                    <p className="text-right">
                                                        ...
                                                        <span className="font-bold text-lg">
                                                            <ProductPrice price={item.quantity * item.price} plain/>
                                                        </span>
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <div>
                            <Card className="rounded-none">
                                <CardContent className="py-4 space-y-4">
                                    {
                                        itemsPrice < FREE_SHIPPIN_MIN_PRICE ? (
                                            <div className="flex-1">
                                                Add
                                                <span className="text-green-700">
                                                    <ProductPrice 
                                                        price={FREE_SHIPPIN_MIN_PRICE - itemsPrice}
                                                        plain
                                                    />
                                                    of eligible ites to add your order to qualify for Free Shipping
                                                </span>
                                            </div>
                                        ): (
                                            <div className="flex-1 ">
